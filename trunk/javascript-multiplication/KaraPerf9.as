//
// KaraPerf9.as: ActionScript performance of two-level Karatsuba multiplication
...
package {
  ...
  public class KaraPerf9 extends Sprite {

    /** Return the difference a - b (assuming it's nonnegative) of two
     * 72-word numbers, yielding a 72-word number.
     */
    internal static function sub72(a : Array, b : Array) : Array {
      var i : int;
      var s : int;
      var carry : int = 0;
      var c : Array = new Array(72);
      for (i = 0; i < 72; ++i) {
     ...
     */
    internal static function sub140(a : Array, b : Array) : Array {
      var i : int;
      var s : int;
      var carry : int = 0;
      var c : Array = new Array(140);
      for (i = 0; i < 140; ++i) {
        if (0 != (carry = int(0 > (s = a[i] - b[i] - carry)))) {
          c[i] = s + 32768;
        } else {
     ...
     */
    internal static function add36(a : Array, b : Array) : Array {
      var i : int;
      var s : int;
      var carry : int = 0;
      var c : Array = new Array(36);
      for (i = 0; i < 36; ++i) {
     ...
     */
    internal static function add70(a : Array, b : Array) : Array {
      var i : int;
      var s : int;
      var carry : int = 0;
      var c : Array = new Array(70);
      for (i = 0; i < 70; ++i) {
        if (0 != (carry = int(32768 <= (s = a[i] + b[i] + carry)))) {
          c[i] = s - 32768;
        } else {
    ...
    internal static function karamult36(a : Array, b : Array) : Array {
      var m : int;
      var d : int;
      var k : int;
      var i : int;
    ...
    internal static function karamult70(a : Array, b : Array) : Array {
      // m=35
      var x0 : Array = a.slice(0, 35);  x0.push(0);
      var x1 : Array = a.slice(35, 70); x1.push(0);
      var y0 : Array = b.slice(0, 35);  y0.push(0);
      var y1 : Array = b.slice(35, 70); y1.push(0);
      // TODO(pts): Create less arrays here.
      var z2 : Array = karamult36(x1, y1);  // 70-word + 0 + 0
      var z0 : Array = karamult36(x0, y0);  // 70-word + 0 + 0
      var z1 : Array = sub72(sub72(         // 71-word + 0
    ...
    internal static function karamult138(a : Array, b : Array) : Array {
      // m=69
      var x0 : Array = a.slice(0, 69);   x0.push(0);
      var x1 : Array = a.slice(69, 138); x1.push(0);
      var y0 : Array = b.slice(0, 69);   y0.push(0);
      var y1 : Array = b.slice(69, 138); y1.push(0);
      // TODO(pts): Create less arrays here.
      var z2 : Array = karamult70(x1, y1);  // 138-word + 0 + 0
      var z0 : Array = karamult70(x0, y0);  // 138-word + 0 + 0
      var z1 : Array = sub140(sub140(       // 139-word + 0
               karamult70(add70(x1, x0), add70(y1, y0)), z2), z0);
      var c : Array = new Array(276);
      var i : int;
      var carry : int = 0;
      var s : int;
    ...
    internal static function newVectorInt(values : Array) : Array {
      var i : int;
    ...
    public function measure() : String {
      ...
      return (date2 - date1) * 2 + ' = MILLISEC(ActionScript3,Flash9)'
    }
  }
}
