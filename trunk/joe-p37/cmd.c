...
CMD cmds[] = {
	...
	{USTR "bkwdhist", TYPETW + TYPEPW + EMOVE, ubkwdhist, NULL, 1, USTR "fwrdhist"},
	...
	{USTR "lcharset", TYPETW + TYPEPW, ulcharset, NULL, 0, NULL},  /* locale charset */
	...
	{USTR "dellin", TYPETW + TYPEPW + EFIXXCOL + EMINOR + EKILL + EMOD, udelln, NULL, 1, NULL}, 
	...
	{USTR "fwrdhist", TYPETW + TYPEPW + EMOVE, ufwrdhist, NULL, 1, USTR "bkwdhist"},
	{USTR "gomark", TYPETW + TYPEPW + EMOVE, ugomark, NULL, 0, NULL},
	{USTR "grep", TYPETW, ugrep, NULL, 0, NULL},
	{USTR "delgrep", TYPETW, udelgrep, NULL, 0, NULL},
	...
	{USTR "nextvw", TYPETW + TYPEPW + TYPEMENU + TYPEQW, unextvw, NULL, 1, USTR "prevvw"},
	...
	{USTR "thiserrbuf", TYPETW, uthiserrbuf, NULL, 0, NULL},
	{USTR "paste", TYPETW + TYPEPW + EMOD, upaste, NULL, 0, NULL },
	{USTR "pbuf", TYPETW, upbuf, NULL, 1, USTR "nbuf"},
	{USTR "pbufu", TYPETW, upbufu, NULL, 1, USTR "nbufu"},
	...
	{USTR "prevvw", TYPETW + TYPEPW + TYPEMENU + TYPEQW, uprevw, NULL, 1, USTR "nextvw"}, 
	...
	{USTR "saveother", TYPETW + TYPEPW, usaveother, NULL, 0, NULL},
	...
	{USTR "tag", TYPETW + TYPEPW, utag, NULL, 1, NULL},
	{USTR "taghere", TYPETW + TYPEPW, utaghere, NULL, 1, NULL},
...
int execmd(CMD *cmd, int k)
{
	...
	if (joe_beep && ret && ret != STOP_REPEATING)
		ttputc(7);
	return ret;
}
